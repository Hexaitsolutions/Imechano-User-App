...
class CarDetailing extends StatefulWidget {
  @override
  _CarDetailingState createState() => _CarDetailingState();
}

class _CarDetailingState extends State<CarDetailing> {
  // ignore: unused_field
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: WidgetAppBar(
          title: getTranslated('upholstery', context),
  ...
  Widget _topImage() {
    return Container(
      ...
      child: Image.asset('assets/images/cardetailing.png'),
    );
  }
        ...
        child: Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: 'What is the situation...'),
          ),
        ),
      ),
    );
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Text(
            ...
            style: TextStyle(fontSize: 15.sp, fontFamily: 'Poppins3'),
          ),
        ),
      ),
    );
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 13.sp, fontFamily: 'Montserrat1'),
                        ),
                      ),
                      SizedBox(
                        height: 10.h,
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    if (_selectedValue.hour < 8 ||
                      ...
                      await callemergencyCarBookingAPI();
  ...
  dynamic callemergencyCarBookingAPI() async {
    bool isCarAdded = PrefObj.preferences!.containsKey(PrefKeys.CARID);
    if (isCarAdded) {
      // String itemId =
      // widget.selectedService['item_id'].toString().split('[')[1];
      // print(json.encode(widget.selectedService['item_id']));
      // print(itemId.split(']')[0]);
      // show loader

      //
      // print("Calling Api Car detailing ....");
      // print(userStr);
      // print(DateFormat('yyyy/MM/dd kk:mm').format(_dateTime),);
      // print(address);
      // print(PrefObj.preferences!.get(PrefKeys.CARID));
      // print(workdoneController.text);
      // //print(imagefiles.toString());

      final CarBookingModal? isCarBooked =
          await _repository.carDetailingBookingApi(
              userStr,
