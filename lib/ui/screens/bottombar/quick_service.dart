...
class QuickServices extends StatefulWidget {
  @override
  _QuickServiceState createState() => _QuickServiceState();
}

class _QuickServiceState extends State<QuickServices> {
  // ignore: unused_field
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: WidgetAppBar(
          title: getTranslated('QuickService', context),
  ...
  Widget _topImage() {
    return Container(
      ...
      child: Image.asset('assets/images/quickservice.png'),
    );
  }
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    if (_selectedValue.hour < 8 ||
                      ...
                      await callemergencyCarBookingAPI(context);
  ...
  dynamic callemergencyCarBookingAPI(context) async {
    ...
    if (isCarAdded) {
      ...
      final CarBookingModal? isCarBooked =
          await _repository.quickServiceBookingApi(
              userStr,
