                      ...
                      imagefiles != null
                          ...
                          : Container(
                              ...
                              GestureDetector(
                                child: Text(
                                  getTranslated(
                                      'uploadhereyourcarsimages', context),
                                  style: TextStyle(
                                    fontSize: 14.sp,
                                    fontFamily: 'Poppins1',
                                    color: buttonNaviBlue4c5e6bBorder,
        ...
        child: Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: getTranslated("whatisthesituation", context)),
          ),
        ),
      ),
    );
  ...
  Widget _whatsappButton() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          getTranslated('whatsapp', context),
          style: TextStyle(
              fontFamily: 'Poppins1', color: Colors.white, fontSize: 18),
        ),
      ),
