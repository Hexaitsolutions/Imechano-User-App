...
class CarCheckupPage extends StatefulWidget {
  @override
  _CarCheckupPageState createState() => _CarCheckupPageState();
}

class _CarCheckupPageState extends State<CarCheckupPage> {
  // ignore: unused_field
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: WidgetAppBar(
          title: getTranslated('CarCheckup', context),
  ...
  Widget _topImage() {
    return Container(
      ...
      child: Image.asset('assets/images/carcheckup.png'),
    );
  }
        ...
        child: Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: getTranslated('Problemyourcashas?', context)),
          ),
        ),
      ),
    );
  ...
  dynamic carcheckupCarBookingAPI() async {
    ...
    if (isCarAdded) {
      ...
      final CarBookingModal? isCarBooked =
          await _repository.carCheckupbookingApi(
              userStr,
