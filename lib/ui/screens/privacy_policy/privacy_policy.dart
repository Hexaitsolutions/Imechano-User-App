...
//
//   faqList({Key? key, required this.title, required this.data}) : super(key: key);
//   final String title;
//
//   @override
...
//                   color:
//                   appModelTheme.darkTheme ? Color(0xff252525) : Colors.white,
...
//               child: Container(
//                 // height: 48.h,
//                 //  margin: EdgeInsets.only(left: 130.w, right: 0.w),
//                   child: Center(
//                     child: Text(
//                       'FAQ',
//                       style:
...
// // import 'package:flutter/material.dart';
// // class faqList extends StatefulWidget {
// //   const faqList({Key? key, required String title, required List<List<String>> data}) : super(key: key);
// //
  ...
  build(context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: GestureDetector(
            ...
            child: Container(
                padding: EdgeInsets.only(top: 30, bottom: 15, left: 17),
            ...
            AccordionSection(
                ...
                content: Column(
                  children: [
                    ...
                    reusableText("2.2. ",
                        "Your access and use of the services constitute your agreement to be bound by these terms, establishing a contractualrelationship between you and the company. If you do not agree to these terms, you may not access or use theservices. These terms expressly supersede prior agreements or arrangements with you. The company mayimmediately terminate these terms or any services with respect to you or, generally, cease offering or deny access to the services or any portion thereof at any time for any reason."),
                    reusableText("2.3. ",
                        "Supplemental terms may apply to certain services. Supplemental terms are in addition to and shall be deemed a part of the terms for the purposes of the applicable services. Supplemental terms shall prevail over these terms in the event of a conflict with respect to theapplicable services."),
                    reusableText("2.4. ",
                        "The company may amend the terms related to the services from time to time. Amendments will be effective upon the company’s posting of such updated terms at this location or the amended policies or supplemental terms on the applicable service. Your continued access or use of the services after such posting constitutes your consent to be bound by the terms, asamended."),
                    reusableText("2.5. ",
                        "Our collection and use of personal information in connection with the services is provided in the company‘s privacy policy below. The company may provide a claims processor or an insurer with any necessary information (including your contact information) if there is a complaint, dispute, or conflict and such information or data is necessary to resolve the complaint, dispute, or conflict."),
                  ],
                )),
            AccordionSection(
                isOpen: false,
