...
class quickServiceBookingApis {
  // ignore: non_constant_identifier_names
  Future<dynamic> quickServicecarbooking(
      String customerid,
      String timedate,
      String address,
      String carId,
    ...
    try {
      final uri = Uri.parse(Config.apiurl + Config.quickbooking);
...
final QuickServiceBookingApi = quickServiceBookingApis();
