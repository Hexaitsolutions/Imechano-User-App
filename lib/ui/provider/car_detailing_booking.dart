...
class carDetailingBookingApis {
  // ignore: non_constant_identifier_names
  Future<dynamic> carDeatilingoncarbookings(
      String customerid,
      String timedate,
      String address,
      String carId,
    ...
    try {
      final uri = Uri.parse(Config.apiurl + Config.detailingbooking);
...
final CarDetailingBookingApi = carDetailingBookingApis();
